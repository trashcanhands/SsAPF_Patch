...
Download Autopathfinder_Patch.zip, install the mod as usual using the .sml file. <b><i>Make sure you put the patch after the Autopathfinder mod in your MSL load order.</i></b> <br><br>
